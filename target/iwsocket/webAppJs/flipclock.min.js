...
!function (a) {
    ...
    }, FlipClock.Lang = {}, FlipClock.Base = Base.extend({buildDate: "2014-12-12", version: "0.7.7", constructor: function (b, c) {
    ...
    "use strict";
    FlipClock.Face = FlipClock.Base.extend({autoStart: !0, dividers: [], factory: !1, lists: [], constructor: function (a, b) {
    ...
    "use strict";
    FlipClock.List = FlipClock.Base.extend({digit: 0, classes: {active: "flip-clock-active", before: "flip-clock-before", flip: "flip"}, factory: !1, $el: !1, $obj: !1, items: [], lastDigit: 0, constructor: function (a, b) {
    ...
    FlipClock.CounterFace = FlipClock.Face.extend({shouldAutoIncrement: !1, constructor: function (a, b) {
